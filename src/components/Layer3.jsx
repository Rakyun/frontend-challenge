  ...
  return (
    <div className="w-screen  flex px-9 py-48 justify-center relative">
      <img
        src={PatternBig}
        alt="patternBig"
        className="hidden md:block w-[1100px] h-[500px] absolute -z-10 scale-x-125 scale-y-100 bottom-[27rem]  "
      />
      <div className="block md:hidden w-[1024px] h-[500px] absolute -z-20  bottom-[27rem]  bg-[#685DC5]"></div>
